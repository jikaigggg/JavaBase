            ...
            <ul class="pagination">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    <c:if test="${pb.currentPage == i}">
                        <li class="active"><a
                                href="${pageContext.request.contextPath}/finduserbypageservlet?currentPage=${i}&rows=${pb.rows}">${i}</a>
                        </li>
                    </c:if>
                    <c:if test="${pb.currentPage != i}">
                        <li>
                            <a href="${pageContext.request.contextPath}/finduserbypageservlet?currentPage=${i}&rows=${pb.rows}">${i}</a>
                        </li>
                    </c:if>
                </c:forEach>
